        ...
        <div className = "container-fluid project-image">
                ...
                <div className="project-1 planner">
                 ...
                 <div className="project-1 quiz">
                    ...
                    <div className="links"><a href="https://github.com/luvkil/javascript-code-quiz"><p>daily-planner</p></a></div>
                </div>
                
                 <div className="project-1 note">
                    <img src = {Img3} alt="project"/>

                    <div className="links"><a href="https://github.com/luvkil/javascript-code-quiz"><p>the match maker</p></a></div>
                </div>
